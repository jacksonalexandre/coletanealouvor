...
namespace LouvorJA
{
	public partial class FormSorteio : Form
	{
        ...
        private static FormSorteio frmSorteio = null;
		...
		#region eventos
		void btnSortear_Click(object sender, EventArgs e)
		{
			sortear();
		}
		...
		void FormSorteio_SizeChanged(object sender, EventArgs e)
		{
		...
		void FormSorteio_Load(object sender, EventArgs e)
		{
			load();
		}
		#endregion
